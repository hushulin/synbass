...
var _doParsePlatform = function(_config){
    ...
    var _root = __config,
        _pmap = {win:'trident-1'},
        _bmap = {td:['trident-1','trident'],'td-1':'trident-1',gk:'gecko',wk:'webkit',pt:'presto'},
 ...
 *  // module depend base/global.js and base/util.js in lib
 *  define('{lib}base/event.js',
 *        ['{lib}base/global.js','{lib}base/util.js'],
 *         function(){
 *             // do module implemention
 *         });
 *  // module depend base/global.js in lib and will not be dependted
 *  define(['{lib}base/global.js'],
 *         function(){
 *             // do module implemention
 *         });
 *  // module with no dependence
 *  define('{lib}base/event.js',
 *         function(){
 *             // do module implemention
 *         });
 *  // module with no dependence and will not be dependted
 *  define(function(){
 *             // do module implemention
 *         });
 * @param  {String}   _uri      当前所在文件，确定文件中模块不会被其他文件依赖时可以不用传此参数，比如入口文件
