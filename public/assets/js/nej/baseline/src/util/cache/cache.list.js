...
var f = function(){
     ...
     */
    _proListCache.__doSaveItemToCache = function(_item){
     ...
     * @return {nej.ut._$$ListCache}
     */
    _proListCache._$setLoaded = function(_key){
        this._$getListInCache(_key).loaded = !0;
        return this;
    };
    /**
     * 直接从缓存中取列表<br/>
    ...
    _proListCache.__getItem = function(_options,_item){
        _options = _options||_o;
        this.__doSaveItemToCache(_item);
        this.__doCallbackRequest(_options.rkey,_options);
    };
    /**
     * 添加列表项<br />
    ...
    _proListCache.__addItem = function(_options,_item){
        var _key = _options.key;
        _item = this.__doSaveItemToCache(_item);
        if (!!_item){
            var _list = this._$getListInCache(_key);
            if (!_options.push){
                _list.unshift(_item);
    ...
    _proListCache.__deleteItem = function(_options,_isok){
        var _item,
            _key = _options.key;
        if (!!_isok){
            _item = this.__doRemoveItemInCache(_options.id);
            var _list = this._$getListInCache(_key),
