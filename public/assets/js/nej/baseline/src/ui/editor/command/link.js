...
var f = function(){
    ...
    _proLinkCard.__initNode = function(){
        ...
        _v._$addEvent(this.__btns[1],'click',
                      this.__onOK._$bind(this));
        _v._$addEvent(this.__btns[0],'click',
                      this.__onCancel._$bind(this));
        _v._$addEvent(this.__inputs[0],'focus',
                      this.__showErrorTips._$bind(this,''));
        _v._$addEvent(this.__inputs[1],'focus',
                      this.__showErrorTips._$bind(this,''));
    };
    ...
    _proLinkCard.__onOK = function(){
        ...
        var _flag2= _link.href.search(_reg2);
        if(_flag2<0){
